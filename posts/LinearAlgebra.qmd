...
This is done by finding roots of $\phi_A(\lambda)=0$.
...
0 & 0 & 2 \\
\end{bmatrix} \\
\phi_A(\lambda) &= (1-\lambda)^2(2-\lambda)
\end{align*}
$$

The matrix above is still a full rank but has two eigen values $\lambda_1 = 1$ and $\lambda_2 = 2$.
