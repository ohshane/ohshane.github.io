...
I can't express enough about how much this meant to me.

We need to know some basics of Jensen's inequality to prove this.
Check out the [post](JensensInequality.qmd) to see more.
...
&= \log_2 \sum_{i=1}^N 2^{-\lambda_i} \leq \log_2 1 &\cdots \text{Kraft inequality} \\[10pt]
&= 0
\end{align*}
$$
