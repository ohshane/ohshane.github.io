---
title: Measureing Distributions
subtitle: Spanning All Measures
description: ""
author: Shane Oh
date: 2024-10-04
image: false
...
$$
\sum_{i=1}^N p_X(\mathbf x_i) \lambda_i \leq
\sum_{i=1}^N p_X(\mathbf x_i) \lambda_i^{'}
$$

Similarly, the optimality in entropy can be proved with Gibbs' inequality.
