...
The session layer establishes, maintains, and terminates **sessions** (dialogs) between applications. It handles dialog control (who transmits when, full- or half-duplex) and **checkpointing/resynchronization**.
You can see that this is usefull when file sharing etc.
NetBIOS operates at this layer to provide session services for applications on a local network.
